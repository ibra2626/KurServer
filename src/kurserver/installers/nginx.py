...
def _generate_nginx_config(domain: str, web_root: str, enable_ssl: bool = False,
                         enable_php: bool = False, php_version: str = "8.1") -> str:
    """
    ...
    Args:
        ...
        enable_ssl (bool): Enable SSL configuration
        enable_php (bool): Enable PHP-FPM configuration
        php_version (str): PHP version to use
...
"""
    ...
    # Try to serve files as is, fallback to PHP
    location / {{
...
"""
    ...
    if enable_ssl:
        config += f"""# SSL configuration for {domain}
server {{
